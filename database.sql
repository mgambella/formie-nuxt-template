...
CREATE TABLE `entrytypes` (
  ...
  `slugTranslationMethod` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'site',
  `slugTranslationKeyFormat` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
) ENGINE=InnoDB AUTO_INCREMENT=1382 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fmc__group` (
  ...
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '0',
  `field_singleLineText_ztmiffjd` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `fmc__repeater` (
  ...
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '0',
  `field_singleLineText_iwxbemtd` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `fmc_contactform` (
  ...
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '0',
  `field_yourName_wfoqhoys` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `field_emailAddress_zedkdxnz` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_message_anpfmdrt` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `fmc_fieldsdemo` (
  ...
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '0',
  `field_singleLineText_stxyhxuq` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_multiLineText_rlyleqcg` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `field_radioButtons_vvcuvxgl` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_checkboxes_fhlljkeg` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_dropdown_shomclgg` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_dropdownMulti_lwxydzmz` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_number_ycewvcut` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `field_name1_xnxyjcwz` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `field_nameMulti_apubilmo` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `field_emailAddress_ksljfbcs` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_phoneNumber_cpqcmqua` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_phoneNumberCountry_hiuggqlo` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `field_agree_omhebvzo` tinyint(1) DEFAULT NULL,
  `field_date_mpgmazyu` datetime DEFAULT NULL,
  `field_address_tznvppqp` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `field_recipientsHidden_ykhycpjf` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_recipientsDropdown2_bmatqfmz` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_recipientsCheckboxes_edlrdxqp` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_recipientsRadio_xfpbsfcp` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_hidden_gvwchqyo` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `field_table_gwfnpuih` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `formie_forms` (
  `id` int NOT NULL AUTO_INCREMENT,
  `handle` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `fieldContentTable` varchar(74) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `settings` mediumtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `templateId` int DEFAULT NULL,
  `submitActionEntryId` int DEFAULT NULL,
  `submitActionEntrySiteId` int DEFAULT NULL,
  `defaultStatusId` int DEFAULT NULL,
  `dataRetention` enum('forever','minutes','hours','days','weeks','months','years') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'forever',
  `dataRetentionValue` int DEFAULT NULL,
  `userDeletedAction` enum('retain','delete') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'retain',
  `fileUploadsAction` enum('retain','delete') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'retain',
...
CREATE TABLE `formie_formtemplates` (
  ...
  `outputCssLocation` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `outputJsLocation` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `sortOrder` smallint unsigned DEFAULT NULL,
  `fieldLayoutId` int DEFAULT NULL,
  `dateDeleted` datetime DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
...
CREATE TABLE `formie_integrations` (
  ...
  `settings` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `cache` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
--
-- Table structure for table `formie_newlayout`
--

DROP TABLE IF EXISTS `formie_newlayout`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `formie_newlayout` (
  `id` int NOT NULL AUTO_INCREMENT,
  `formId` int NOT NULL,
  `layoutConfig` longtext,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
...
--
-- Table structure for table `formie_newnestedlayout`
--

DROP TABLE IF EXISTS `formie_newnestedlayout`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `formie_newnestedlayout` (
  `id` int NOT NULL AUTO_INCREMENT,
  `fieldId` int NOT NULL,
  `layoutConfig` longtext,
  `dateCreated` datetime NOT NULL,
...
CREATE TABLE `formie_notifications` (
  ...
  `toConditions` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  ...
  `attachAssets` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE `formie_payments` (
  ...
  `status` enum('pending','redirect','success','failed','processing') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `formie_payments_plans` (
  ...
  `planData` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE `formie_payments_subscriptions` (
  ...
  `reference` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `subscriptionData` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE `formie_pdftemplates` (
  ...
  `handle` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `template` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `filenameFormat` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `sortOrder` smallint unsigned DEFAULT NULL,
  `dateDeleted` datetime DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
...
CREATE TABLE `formie_statuses` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `handle` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `color` enum('green','orange','red','blue','yellow','pink','purple','turquoise','light','grey','black') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'green',
...
CREATE TABLE `formie_submissions` (
  ...
  `spamReason` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `spamClass` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `snapshot` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE `formie_tokens` (
  `id` int NOT NULL AUTO_INCREMENT,
  `type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `accessToken` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `secret` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `endOfLife` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `refreshToken` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
(4,1,NULL,NULL,'2021-08-07 00:11:05','2021-08-07 00:11:05'),
(5,1,NULL,NULL,'2021-08-07 00:11:08','2021-08-07 00:11:08'),
(6,1,NULL,NULL,'2021-08-07 00:11:12','2021-08-07 00:11:12'),
(7,1,NULL,NULL,'2021-08-07 00:11:16','2021-08-07 00:11:16');
...
(2,2,1,NULL,'2021-08-07 00:06:03','2024-05-30 13:30:17','4f09d160-8289-4e57-a598-630d308c3c7c',NULL),
...
(19,19,1,'Contact Form','2023-09-02 11:34:09','2023-09-02 11:34:09','c2eba1b2-6beb-40f5-8bec-5ccd45f3232b',NULL),
(20,20,1,'Fields Demo','2023-09-02 11:34:24','2023-09-02 11:34:24','a850022a-2851-478a-ba16-f5c9cfe97b8c',NULL);
...
(2,NULL,NULL,NULL,5,'craft\\elements\\GlobalSet',1,0,'2021-08-07 00:06:03','2024-05-30 13:30:17',NULL,NULL,'6b96e0b0-0c3f-4de5-8631-0de30b34872c'),
...
(3,1,NULL,1,1,'2021-08-07 00:10:00',NULL,NULL,'2021-08-07 00:10:57','2021-08-07 00:10:57'),
(8,1,NULL,1,1,'2021-08-07 00:10:00',NULL,NULL,'2021-08-07 00:11:23','2021-08-07 00:11:23'),
(9,1,NULL,1,1,'2021-08-07 00:11:00',NULL,NULL,'2021-08-07 00:11:23','2021-08-07 00:11:23'),
(10,1,NULL,1,1,'2021-08-07 00:11:00',NULL,NULL,'2021-08-07 00:11:29','2021-08-07 00:11:29'),
(11,1,NULL,1,1,'2021-08-07 00:11:00',NULL,NULL,'2021-08-07 00:11:30','2021-08-07 00:11:30'),
(12,1,NULL,1,1,'2021-08-07 00:11:00',NULL,NULL,'2021-08-07 00:11:35','2021-08-07 00:11:35'),
(13,1,NULL,1,1,'2021-08-07 00:11:00',NULL,NULL,'2021-08-07 00:11:36','2021-08-07 00:11:36');
...
(1,1,1,'Default','default',1,'site',NULL,NULL,'site',NULL,1,1,'2021-08-07 00:05:46','2021-08-07 00:05:46',NULL,'ee2e044d-867d-4cdf-b1b3-4e0d51e7a818');
...
(1330,10,98,40,0,0,'2023-09-02 11:34:09','2023-09-02 11:34:09','5b423075-ddb0-4252-a48e-f07b781b7960'),
(1331,10,98,41,1,1,'2023-09-02 11:34:09','2023-09-02 11:34:09','d535ff4b-a3d7-4c37-9494-bf4fb9215f5c'),
(1332,10,98,42,1,2,'2023-09-02 11:34:09','2023-09-02 11:34:09','01070f50-b0d2-4b44-821e-038ad6a20586'),
(1333,11,99,65,0,0,'2023-09-02 11:34:24','2023-09-02 11:34:24','346237c0-a34c-4166-909c-f3c3f0c12e1d'),
(1334,12,100,68,0,0,'2023-09-02 11:34:24','2023-09-02 11:34:24','461a1155-b044-43eb-a7cf-95e06523cd82'),
(1335,13,101,43,0,0,'2023-09-02 11:34:24','2023-09-02 11:34:24','84d584ba-82df-4c4e-b6f2-ec4726ea4893'),
(1336,13,101,44,0,1,'2023-09-02 11:34:24','2023-09-02 11:34:24','1f2d91ca-b92d-40cd-a72b-32140f098153'),
(1337,13,101,45,0,2,'2023-09-02 11:34:24','2023-09-02 11:34:24','3e802e1c-8201-4ad1-ad2c-28e9c9a14768'),
(1338,13,101,46,0,3,'2023-09-02 11:34:24','2023-09-02 11:34:24','4bdfd136-037b-46b9-90ce-1e8d8c347616'),
(1339,13,101,47,0,4,'2023-09-02 11:34:24','2023-09-02 11:34:24','e4c6dfb1-e280-4367-bbbb-80966d138d54'),
(1340,13,101,48,0,5,'2023-09-02 11:34:24','2023-09-02 11:34:24','474be66a-5fe2-400b-9a1f-2256933c7f21'),
(1341,13,101,49,0,6,'2023-09-02 11:34:24','2023-09-02 11:34:24','6eefe836-59de-451a-87a1-56fbdafd18af'),
(1342,13,101,50,0,7,'2023-09-02 11:34:24','2023-09-02 11:34:24','185ac006-4434-45f1-b26f-2bbf6bdbbdfc'),
(1343,13,101,51,0,8,'2023-09-02 11:34:24','2023-09-02 11:34:24','6edf0e09-a506-415c-ac3a-5e51b40914da'),
(1344,13,101,52,0,9,'2023-09-02 11:34:24','2023-09-02 11:34:24','552cd351-04c8-4448-b5e4-dea765e55584'),
(1345,13,101,53,0,10,'2023-09-02 11:34:24','2023-09-02 11:34:24','72d7fc03-bcf7-40a9-9a46-cdc3b75a266f'),
(1346,13,101,54,0,11,'2023-09-02 11:34:24','2023-09-02 11:34:24','6b6ac1da-4b5b-47f9-8396-0fcdd671e696'),
(1347,13,101,55,0,12,'2023-09-02 11:34:24','2023-09-02 11:34:24','69d51f86-989b-4f64-b913-7cdb3deea741'),
(1348,13,102,56,0,0,'2023-09-02 11:34:24','2023-09-02 11:34:24','e0b887f8-7264-43b4-bd7f-2d95e61a5817'),
(1349,13,102,57,0,1,'2023-09-02 11:34:24','2023-09-02 11:34:24','90c68a90-4026-44c1-a814-46ed11bc57ee'),
(1350,13,102,58,0,2,'2023-09-02 11:34:24','2023-09-02 11:34:24','ad45f76a-4fb7-4bfc-843c-979943e0e5ab'),
(1351,13,102,59,0,3,'2023-09-02 11:34:24','2023-09-02 11:34:24','24888ed1-741b-4d9f-a778-36adfc8491ae'),
(1352,13,102,60,0,4,'2023-09-02 11:34:24','2023-09-02 11:34:24','634ee5a4-2570-405f-a96d-be0bc82c01e2'),
(1353,13,102,61,0,5,'2023-09-02 11:34:24','2023-09-02 11:34:24','edc1cb35-da02-45f9-b67d-846a568a6435'),
(1354,13,102,62,0,6,'2023-09-02 11:34:24','2023-09-02 11:34:24','0700ae5d-1e04-4834-a6c3-ad689aa8adbf'),
(1355,13,102,63,0,7,'2023-09-02 11:34:24','2023-09-02 11:34:24','3c8a2f65-4d1f-4fc1-b8f8-28b2aabea438'),
(1356,13,102,64,0,8,'2023-09-02 11:34:24','2023-09-02 11:34:24','133ccbcf-a52a-4d60-a5ed-987b19e074e7'),
(1357,13,102,66,0,9,'2023-09-02 11:34:24','2023-09-02 11:34:24','7d62832e-abea-4498-ac5f-bca789dba97f'),
(1358,13,102,67,0,10,'2023-09-02 11:34:24','2023-09-02 11:34:24','c10b6c9a-8fcf-4c5b-8738-dd60511d3e25'),
(1359,13,102,69,0,11,'2023-09-02 11:34:24','2023-09-02 11:34:24','4a8d7ea9-ea69-49f6-a256-eefac858603d'),
(1360,13,102,70,0,12,'2023-09-02 11:34:24','2023-09-02 11:34:24','0868120f-1a2d-405a-9d70-cd99ebc216ae'),
(1361,13,102,71,0,13,'2023-09-02 11:34:24','2023-09-02 11:34:24','2f1c3dbb-44e5-4d80-a75a-da3b926a37e3'),
(1362,13,103,72,0,0,'2023-09-02 11:34:24','2023-09-02 11:34:24','14bb5cc7-02f0-48f1-805a-b287bb83e388'),
(1363,13,103,73,0,1,'2023-09-02 11:34:24','2023-09-02 11:34:24','e1a153c2-dab5-4415-8962-85796503b766'),
(1364,13,103,74,0,2,'2023-09-02 11:34:24','2023-09-02 11:34:24','45479565-e5f4-4c28-a70d-649f5af97457'),
(1365,13,103,75,0,3,'2023-09-02 11:34:24','2023-09-02 11:34:24','73a7f5bd-3bf9-4092-a726-083e41db2677'),
(1366,13,103,76,0,4,'2023-09-02 11:34:24','2023-09-02 11:34:24','983298ba-afc0-4a8e-a3f9-d5ef21502d25'),
(1367,13,103,77,0,5,'2023-09-02 11:34:24','2023-09-02 11:34:24','0eca94af-effc-4ae7-bc08-454c7b5a2c37'),
(1369,3,105,1,0,1,'2024-05-30 13:30:17','2024-05-30 13:30:17','11eeecce-07d7-4378-927c-4a52e9a20d22'),
(1373,5,109,1,0,0,'2024-05-30 13:30:17','2024-05-30 13:30:17','2ec00f7e-211e-4e52-a7fa-26e3e9f9320c'),
(1375,4,111,1,0,1,'2024-05-30 13:30:17','2024-05-30 13:30:17','644d70c8-9320-46f6-8c38-99eda16d3024'),
(1379,2,115,1,0,1,'2024-05-30 13:30:17','2024-05-30 13:30:17','d7c56833-dfcd-47d0-8524-54ba7ec9f35b'),
(1381,1,117,1,0,1,'2024-05-30 13:30:17','2024-05-30 13:30:17','1f070962-f6c1-437b-98eb-bed2843bd899');
...
(10,'verbb\\formie\\elements\\Form','2023-09-02 11:34:09','2023-09-02 11:34:09',NULL,'82d6ead5-8b65-4e26-be8c-8f2edefaa3c0'),
(11,'verbb\\formie\\fields\\formfields\\Repeater','2023-09-02 11:34:24','2023-09-02 11:34:24',NULL,'2872b042-f26a-4633-8642-66d55ac982a2'),
(12,'verbb\\formie\\fields\\formfields\\Group','2023-09-02 11:34:24','2023-09-02 11:34:24',NULL,'212960e6-d4fa-4d40-9836-a646acb41030'),
(13,'verbb\\formie\\elements\\Form','2023-09-02 11:34:24','2023-09-02 11:34:24',NULL,'45596544-7df7-45f3-8c0b-14173830ea9b');
...
(1,1,'Plain Text','plainText','global','kukrbgdv',NULL,0,'none',NULL,'craft\\fields\\PlainText','{\"byteLimit\":null,\"charLimit\":null,\"code\":false,\"columnType\":null,\"initialRows\":4,\"multiline\":false,\"placeholder\":null,\"uiMode\":\"normal\"}','2021-08-07 00:05:27','2024-05-30 13:30:16','2a7dfeb1-2876-4d66-8cb7-ccb1c55b042a'),
...
set autocommit=0;
INSERT INTO `formie_nested` VALUES
(1,64,11,'2023-09-02 11:34:24','2023-09-02 11:34:24','edaf9b45-38c6-4d54-9b94-bed8a4bed7b6'),
(2,67,12,'2023-09-02 11:34:24','2023-09-02 11:34:24','fa7df2a8-739b-4743-9c7a-5d58f1092c9f');
...
--
-- Dumping data for table `formie_newlayout`
--

LOCK TABLES `formie_newlayout` WRITE;
/*!40000 ALTER TABLE `formie_newlayout` DISABLE KEYS */;
set autocommit=0;
INSERT INTO `formie_newlayout` VALUES
(1,20,'{\"pages\":[{\"label\":\"Common\",\"settings\":{\"submitButtonLabel\":\"Next\",\"backButtonLabel\":\"Back\",\"showBackButton\":false,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"right\",\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"enableNextButtonConditions\":false,\"nextButtonConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enablePageConditions\":false,\"pageConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableJsEvents\":false,\"jsGtmEventOptions\":[]},\"rows\":[{\"fields\":[{\"limit\":true,\"min\":null,\"minType\":null,\"max\":10,\"maxType\":\"words\",\"uniqueValue\":false,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":\"test\",\"containerAttributes\":[{\"label\":\"data-test\",\"value\":\"tfgdfg\"}],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\SingleLineText\",\"label\":\"Single Line Text\",\"handle\":\"singleLineText\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"limit\":false,\"min\":null,\"minType\":null,\"max\":null,\"maxType\":\"characters\",\"useRichText\":false,\"richTextButtons\":[\"bold\",\"italic\"],\"uniqueValue\":false,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\MultiLineText\",\"label\":\"Multi Line Text\",\"handle\":\"multiLineText\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"layout\":\"vertical\",\"options\":[{\"label\":\"Option 1\",\"value\":\"Option 1\",\"isDefault\":false},{\"label\":\"Option 2\",\"value\":\"Option 2\",\"isDefault\":false},{\"label\":\"Option 3\",\"value\":\"Option 3\",\"isDefault\":false}],\"columnType\":\"string\",\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Radio\",\"label\":\"Radio Buttons\",\"handle\":\"radioButtons\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"multi\":true,\"layout\":\"vertical\",\"toggleCheckbox\":null,\"toggleCheckboxLabel\":null,\"limitOptions\":false,\"min\":null,\"max\":null,\"options\":[{\"label\":\"Option 1\",\"value\":\"Option 1\",\"isDefault\":false},{\"label\":\"Option 2\",\"value\":\"Option 2\",\"isDefault\":false},{\"label\":\"Option 3\",\"value\":\"Option 3\",\"isDefault\":false}],\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Checkboxes\",\"label\":\"Checkboxes\",\"handle\":\"checkboxes\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"multiple\":false,\"multi\":false,\"optgroups\":true,\"limitOptions\":false,\"min\":null,\"max\":null,\"options\":[{\"label\":\"Select an option\",\"value\":\"\",\"isDefault\":true},{\"label\":\"Option 1\",\"value\":\"Option 1\",\"isDefault\":false},{\"label\":\"Option 2\",\"value\":\"Option 2\",\"isDefault\":false},{\"label\":\"Option 3\",\"value\":\"Option 3\",\"isDefault\":false}],\"columnType\":\"string\",\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Dropdown\",\"label\":\"Dropdown\",\"handle\":\"dropdown\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"multiple\":true,\"multi\":true,\"optgroups\":true,\"limitOptions\":false,\"min\":null,\"max\":null,\"options\":[{\"label\":\"Select an option\",\"value\":\"\",\"isDefault\":true},{\"label\":\"Option 1\",\"value\":\"Option 1\",\"isDefault\":false},{\"label\":\"Option 2\",\"value\":\"Option 2\",\"isDefault\":false},{\"label\":\"Option 3\",\"value\":\"Option 3\",\"isDefault\":false}],\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Dropdown\",\"label\":\"Dropdown Multi\",\"handle\":\"dropdownMulti\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"limit\":false,\"min\":null,\"max\":null,\"decimals\":0,\"uniqueValue\":false,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Number\",\"label\":\"Number\",\"handle\":\"number\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"useMultipleFields\":false,\"prefixEnabled\":false,\"prefixCollapsed\":true,\"prefixLabel\":\"Prefix\",\"prefixPlaceholder\":null,\"prefixDefaultValue\":null,\"prefixPrePopulate\":null,\"prefixRequired\":false,\"prefixErrorMessage\":null,\"firstNameEnabled\":true,\"firstNameCollapsed\":true,\"firstNameLabel\":\"First Name\",\"firstNamePlaceholder\":null,\"firstNameDefaultValue\":null,\"firstNamePrePopulate\":null,\"firstNameRequired\":false,\"firstNameErrorMessage\":null,\"middleNameEnabled\":false,\"middleNameCollapsed\":true,\"middleNameLabel\":\"Middle Name\",\"middleNamePlaceholder\":null,\"middleNameDefaultValue\":null,\"middleNamePrePopulate\":null,\"middleNameRequired\":false,\"middleNameErrorMessage\":null,\"lastNameEnabled\":true,\"lastNameCollapsed\":true,\"lastNameLabel\":\"Last Name\",\"lastNamePlaceholder\":null,\"lastNameDefaultValue\":null,\"lastNamePrePopulate\":null,\"lastNameRequired\":false,\"lastNameErrorMessage\":null,\"subfieldLabelPosition\":null,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Name\",\"label\":\"Name\",\"handle\":\"name1\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"useMultipleFields\":true,\"prefixEnabled\":true,\"prefixCollapsed\":false,\"prefixLabel\":\"Prefix\",\"prefixPlaceholder\":null,\"prefixDefaultValue\":null,\"prefixPrePopulate\":null,\"prefixRequired\":false,\"prefixErrorMessage\":null,\"firstNameEnabled\":true,\"firstNameCollapsed\":true,\"firstNameLabel\":\"First Name\",\"firstNamePlaceholder\":null,\"firstNameDefaultValue\":null,\"firstNamePrePopulate\":null,\"firstNameRequired\":false,\"firstNameErrorMessage\":null,\"middleNameEnabled\":true,\"middleNameCollapsed\":false,\"middleNameLabel\":\"Middle Name\",\"middleNamePlaceholder\":null,\"middleNameDefaultValue\":null,\"middleNamePrePopulate\":null,\"middleNameRequired\":false,\"middleNameErrorMessage\":null,\"lastNameEnabled\":true,\"lastNameCollapsed\":true,\"lastNameLabel\":\"Last Name\",\"lastNamePlaceholder\":null,\"lastNameDefaultValue\":null,\"lastNamePrePopulate\":null,\"lastNameRequired\":false,\"lastNameErrorMessage\":null,\"subfieldLabelPosition\":null,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Name\",\"label\":\"Name Multi\",\"handle\":\"nameMulti\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"validateDomain\":false,\"blockedDomains\":[],\"uniqueValue\":false,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Email\",\"label\":\"Email Address\",\"handle\":\"emailAddress\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"countryEnabled\":false,\"countryCollapsed\":true,\"countryShowDialCode\":true,\"countryDefaultValue\":null,\"countryAllowed\":[],\"subfieldLabelPosition\":null,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Phone\",\"label\":\"Phone Number\",\"handle\":\"phoneNumber\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"countryEnabled\":true,\"countryCollapsed\":true,\"countryShowDialCode\":true,\"countryDefaultValue\":null,\"countryAllowed\":[],\"subfieldLabelPosition\":null,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Phone\",\"label\":\"Phone Number Country\",\"handle\":\"phoneNumberCountry\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"description\":[{\"type\":\"paragraph\",\"content\":[{\"type\":\"text\",\"text\":\"I agree to this\"}]}],\"checkedValue\":\"Yes\",\"uncheckedValue\":\"No\",\"matchField\":null,\"placeholder\":null,\"defaultValue\":false,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Agree\",\"label\":\"Agree\",\"handle\":\"agree\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]}]},{\"label\":\"Advanced\",\"settings\":{\"submitButtonLabel\":\"Next\",\"backButtonLabel\":\"Back\",\"showBackButton\":true,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"left-right\",\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"enableNextButtonConditions\":false,\"nextButtonConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enablePageConditions\":false,\"pageConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableJsEvents\":false,\"jsGtmEventOptions\":[]},\"rows\":[{\"fields\":[{\"dateFormat\":\"Y-m-d\",\"timeFormat\":\"H:i\",\"displayType\":\"calendar\",\"includeDate\":true,\"includeTime\":false,\"timeLabel\":null,\"defaultOption\":null,\"dayLabel\":\"Day\",\"dayPlaceholder\":null,\"monthLabel\":\"Month\",\"monthPlaceholder\":null,\"yearLabel\":\"Year\",\"yearPlaceholder\":null,\"hourLabel\":\"Hour\",\"hourPlaceholder\":null,\"minuteLabel\":\"Minute\",\"minutePlaceholder\":null,\"secondLabel\":\"Second\",\"secondPlaceholder\":null,\"ampmLabel\":\"AM\\/PM\",\"ampmPlaceholder\":null,\"useDatePicker\":true,\"datePickerOptions\":[],\"minDateOption\":\"\",\"minDate\":null,\"minDateOffset\":\"add\",\"minDateOffsetNumber\":0,\"minDateOffsetType\":\"days\",\"maxDateOption\":\"\",\"maxDate\":null,\"maxDateOffset\":\"add\",\"maxDateOffsetNumber\":0,\"maxDateOffsetType\":\"days\",\"minYearRange\":100,\"maxYearRange\":100,\"availableDaysOfWeek\":\"*\",\"subfieldLabelPosition\":null,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Date\",\"label\":\"Date\",\"handle\":\"date\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"autocompleteIntegration\":null,\"autocompleteEnabled\":false,\"autocompleteCollapsed\":true,\"autocompleteLabel\":\"Auto-Complete\",\"autocompletePlaceholder\":null,\"autocompleteDefaultValue\":null,\"autocompletePrePopulate\":null,\"autocompleteRequired\":false,\"autocompleteErrorMessage\":null,\"autocompleteCurrentLocation\":false,\"address1Enabled\":true,\"address1Collapsed\":true,\"address1Label\":\"Address 1\",\"address1Placeholder\":null,\"address1DefaultValue\":null,\"address1PrePopulate\":null,\"address1Required\":false,\"address1ErrorMessage\":null,\"address1Hidden\":false,\"address2Enabled\":true,\"address2Collapsed\":false,\"address2Label\":\"Address 2\",\"address2Placeholder\":null,\"address2DefaultValue\":null,\"address2PrePopulate\":null,\"address2Required\":false,\"address2ErrorMessage\":null,\"address2Hidden\":false,\"address3Enabled\":true,\"address3Collapsed\":false,\"address3Label\":\"Address 3\",\"address3Placeholder\":null,\"address3DefaultValue\":null,\"address3PrePopulate\":null,\"address3Required\":false,\"address3ErrorMessage\":null,\"address3Hidden\":false,\"cityEnabled\":true,\"cityCollapsed\":true,\"cityLabel\":\"City\",\"cityPlaceholder\":null,\"cityDefaultValue\":null,\"cityPrePopulate\":null,\"cityRequired\":false,\"cityErrorMessage\":null,\"cityHidden\":false,\"stateEnabled\":true,\"stateCollapsed\":true,\"stateLabel\":\"State \\/ Province\",\"statePlaceholder\":null,\"stateDefaultValue\":null,\"statePrePopulate\":null,\"stateRequired\":false,\"stateErrorMessage\":null,\"stateHidden\":false,\"zipEnabled\":true,\"zipCollapsed\":true,\"zipLabel\":\"ZIP \\/ Postal Code\",\"zipPlaceholder\":null,\"zipDefaultValue\":null,\"zipPrePopulate\":null,\"zipRequired\":false,\"zipErrorMessage\":null,\"zipHidden\":false,\"countryEnabled\":true,\"countryCollapsed\":true,\"countryLabel\":\"Country\",\"countryPlaceholder\":null,\"countryDefaultValue\":null,\"countryPrePopulate\":null,\"countryRequired\":false,\"countryErrorMessage\":null,\"countryHidden\":false,\"countryOptionLabel\":\"full\",\"countryOptionValue\":\"short\",\"subfieldLabelPosition\":null,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Address\",\"label\":\"Address\",\"handle\":\"address\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"searchable\":true,\"sizeLimit\":null,\"sizeMinLimit\":null,\"limitFiles\":null,\"restrictFiles\":true,\"allowedKinds\":[\"image\",\"pdf\"],\"uploadLocationSource\":\"volume:adf62689-9e99-4040-8bb3-c06de71033be\",\"uploadLocationSubpath\":null,\"restrictLocation\":true,\"filenameFormat\":null,\"restrictedLocationSource\":\"volume:adf62689-9e99-4040-8bb3-c06de71033be\",\"restrictedLocationSubpath\":\"\",\"allowSubfolders\":false,\"restrictedDefaultUploadSubpath\":null,\"defaultUploadLocationSource\":null,\"defaultUploadLocationSubpath\":null,\"allowUploads\":true,\"showUnpermittedVolumes\":false,\"showUnpermittedFiles\":false,\"previewMode\":\"full\",\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"limitOptions\":null,\"displayType\":\"dropdown\",\"labelSource\":\"title\",\"orderBy\":\"title ASC\",\"multiple\":false,\"allowSelfRelations\":false,\"localizeRelations\":false,\"maxRelations\":null,\"minRelations\":null,\"selectionLabel\":null,\"showSiteMenu\":false,\"sources\":\"*\",\"targetSiteId\":null,\"validateRelatedElements\":false,\"viewMode\":null,\"maintainHierarchy\":false,\"branchLimit\":null,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\FileUpload\",\"label\":\"File Upload\",\"handle\":\"fileUpload\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"displayType\":\"hidden\",\"options\":[],\"multiple\":null,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":\"verbb\\\\formie\\\\positions\\\\Hidden\",\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Recipients\",\"label\":\"Recipients - Hidden\",\"handle\":\"recipientsHidden\",\"required\":false,\"instructions\":null}]},{\"fields\":[{\"displayType\":\"dropdown\",\"options\":[{\"label\":\"Recipient 1\",\"value\":\"Recipient 1\",\"isDefault\":false},{\"label\":\"Recipient 2\",\"value\":\"Recipient 2\",\"isDefault\":false},{\"label\":\"Recipient 3\",\"value\":\"Recipient 3\",\"isDefault\":false}],\"multiple\":null,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Recipients\",\"label\":\"Recipients - Dropdown\",\"handle\":\"recipientsDropdown2\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"displayType\":\"checkboxes\",\"options\":[{\"label\":\"Recipient 1\",\"value\":\"Recipient 1\",\"isDefault\":false},{\"label\":\"Recipient 2\",\"value\":\"Recipient 2\",\"isDefault\":false},{\"label\":\"Recipient 3\",\"value\":\"Recipient 3\",\"isDefault\":false}],\"multiple\":null,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Recipients\",\"label\":\"Recipients - Checkboxes\",\"handle\":\"recipientsCheckboxes\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"displayType\":\"radio\",\"options\":[{\"label\":\"Recipient 1\",\"value\":\"Recipient 1\",\"isDefault\":false},{\"label\":\"Recipient 2\",\"value\":\"Recipient 2\",\"isDefault\":false},{\"label\":\"Recipient 3\",\"value\":\"Recipient 3\",\"isDefault\":false}],\"multiple\":null,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Recipients\",\"label\":\"Recipients - Radio\",\"handle\":\"recipientsRadio\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"defaultOption\":\"custom\",\"queryParameter\":null,\"cookieName\":null,\"columnType\":null,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":\"verbb\\\\formie\\\\positions\\\\Hidden\",\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":null,\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Hidden\",\"label\":\"Hidden\",\"handle\":\"hidden\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"minRows\":null,\"maxRows\":null,\"addLabel\":\"Add another row\",\"contentTable\":\"{{%fmc__repeater}}\",\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Repeater\",\"label\":\"Repeater\",\"handle\":\"repeater\",\"required\":false,\"instructions\":\"Please fill out this field.\",\"rows\":[{\"fields\":[{\"limit\":false,\"min\":null,\"minType\":null,\"max\":null,\"maxType\":\"characters\",\"uniqueValue\":false,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":true,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\SingleLineText\",\"label\":\"Single Line Text\",\"handle\":\"singleLineText\",\"required\":false,\"instructions\":null}]}]}]},{\"fields\":[{\"searchable\":true,\"columns\":{\"col1\":{\"heading\":\"Column 1\",\"handle\":\"column1\",\"width\":\"\",\"type\":\"checkbox\"},\"col2\":{\"heading\":\"Column 2\",\"handle\":\"column2\",\"width\":\"\",\"type\":\"color\"},\"col3\":{\"heading\":\"Column 3\",\"handle\":\"column3\",\"width\":\"\",\"type\":\"date\"},\"col4\":{\"heading\":\"Column 4\",\"handle\":\"column4\",\"width\":\"\",\"type\":\"select\",\"options\":[{\"label\":\"Option 1\",\"value\":\"Option 1\",\"isOptgroup\":false,\"isDefault\":false},{\"label\":\"Option 2\",\"value\":\"Option 2\",\"isOptgroup\":false,\"isDefault\":false}]},\"col5\":{\"heading\":\"Column 5\",\"handle\":\"column5\",\"width\":\"\",\"type\":\"email\"},\"col6\":{\"heading\":\"Column 6\",\"handle\":\"column6\",\"width\":\"\",\"type\":\"heading\"},\"col7\":{\"heading\":\"Column 7\",\"handle\":\"column7\",\"width\":\"\",\"type\":\"multiline\"},\"col8\":{\"heading\":\"Column 8\",\"handle\":\"column8\",\"width\":\"\",\"type\":\"number\"},\"col9\":{\"heading\":\"Column 9\",\"handle\":\"column9\",\"width\":\"\",\"type\":\"time\"},\"col10\":{\"heading\":\"Column 10\",\"handle\":\"column10\",\"width\":\"\",\"type\":\"singleline\"},\"col11\":{\"heading\":\"Column 11\",\"handle\":\"column11\",\"width\":\"\",\"type\":\"url\"}},\"static\":false,\"staticRows\":false,\"addRowLabel\":\"Add row\",\"maxRows\":null,\"minRows\":null,\"defaults\":[],\"columnType\":\"text\",\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Table\",\"label\":\"Table\",\"handle\":\"table\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"contentTable\":\"{{%fmc__group}}\",\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Group\",\"label\":\"Group\",\"handle\":\"group\",\"required\":false,\"instructions\":\"Please fill out this field.\",\"rows\":[{\"fields\":[{\"limit\":false,\"min\":null,\"minType\":null,\"max\":null,\"maxType\":\"characters\",\"uniqueValue\":false,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":true,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\SingleLineText\",\"label\":\"Single Line Text\",\"handle\":\"singleLineText\",\"required\":false,\"instructions\":null}]}]}]},{\"fields\":[{\"headingSize\":\"h2\",\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Heading\",\"label\":\"Heading\",\"handle\":\"heading\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"borderStyle\":\"solid\",\"borderWidth\":1,\"borderColor\":\"#ccc\",\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Section\",\"label\":\"Section Label 8c87d454f6b8ad60c607060871764fb3\",\"handle\":\"sectionHandlef63e8fa27dab4d7b0b535ea46ded86ab\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"htmlContent\":null,\"purifyContent\":true,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Html\",\"label\":\"HTML\",\"handle\":\"html\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]}]},{\"label\":\"Elements\",\"settings\":{\"submitButtonLabel\":\"Finish\",\"backButtonLabel\":\"Back\",\"showBackButton\":true,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"left-right\",\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"enableNextButtonConditions\":false,\"nextButtonConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enablePageConditions\":false,\"pageConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableJsEvents\":false,\"jsGtmEventOptions\":[]},\"rows\":[{\"fields\":[{\"searchable\":true,\"matchField\":null,\"placeholder\":\"Select an entry\",\"defaultValue\":[],\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"limitOptions\":null,\"displayType\":\"dropdown\",\"labelSource\":\"title\",\"orderBy\":\"id ASC\",\"multiple\":false,\"allowSelfRelations\":false,\"localizeRelations\":false,\"maxRelations\":null,\"minRelations\":null,\"selectionLabel\":null,\"showSiteMenu\":false,\"sources\":\"*\",\"targetSiteId\":null,\"validateRelatedElements\":false,\"viewMode\":null,\"maintainHierarchy\":false,\"branchLimit\":null,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Entries\",\"label\":\"Entries - Dropdown\",\"handle\":\"entriesDropdown\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"searchable\":true,\"matchField\":null,\"placeholder\":\"Select an entry\",\"defaultValue\":[],\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"limitOptions\":null,\"displayType\":\"checkboxes\",\"labelSource\":\"title\",\"orderBy\":\"id ASC\",\"multiple\":false,\"allowSelfRelations\":false,\"localizeRelations\":false,\"maxRelations\":null,\"minRelations\":null,\"selectionLabel\":null,\"showSiteMenu\":false,\"sources\":\"*\",\"targetSiteId\":null,\"validateRelatedElements\":false,\"viewMode\":null,\"maintainHierarchy\":false,\"branchLimit\":null,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Entries\",\"label\":\"Entries - Checkboxes\",\"handle\":\"entriesCheckboxes\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"searchable\":true,\"matchField\":null,\"placeholder\":\"Select an entry\",\"defaultValue\":[],\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"limitOptions\":null,\"displayType\":\"radio\",\"labelSource\":\"title\",\"orderBy\":\"id ASC\",\"multiple\":false,\"allowSelfRelations\":false,\"localizeRelations\":false,\"maxRelations\":null,\"minRelations\":null,\"selectionLabel\":null,\"showSiteMenu\":false,\"sources\":\"*\",\"targetSiteId\":null,\"validateRelatedElements\":false,\"viewMode\":null,\"maintainHierarchy\":false,\"branchLimit\":null,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Entries\",\"label\":\"Entries - Radio\",\"handle\":\"entriesRadio\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"searchable\":true,\"rootCategory\":null,\"showStructure\":false,\"matchField\":null,\"placeholder\":\"Select a category\",\"defaultValue\":[],\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"limitOptions\":null,\"displayType\":\"dropdown\",\"labelSource\":\"id\",\"orderBy\":\"id ASC\",\"multiple\":false,\"allowSelfRelations\":false,\"localizeRelations\":false,\"maxRelations\":null,\"minRelations\":null,\"selectionLabel\":null,\"showSiteMenu\":false,\"source\":\"group:12530c06-549d-4664-97d3-2a96906bde12\",\"targetSiteId\":null,\"validateRelatedElements\":false,\"viewMode\":null,\"maintainHierarchy\":true,\"branchLimit\":null,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Categories\",\"label\":\"Categories\",\"handle\":\"categories\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"searchable\":true,\"matchField\":null,\"placeholder\":\"Select a tag\",\"defaultValue\":[],\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"limitOptions\":null,\"displayType\":\"dropdown\",\"labelSource\":\"title\",\"orderBy\":\"title ASC\",\"multiple\":false,\"allowSelfRelations\":false,\"localizeRelations\":false,\"maxRelations\":null,\"minRelations\":null,\"selectionLabel\":null,\"showSiteMenu\":false,\"source\":\"taggroup:9ee7d758-c5b1-4f5a-a4d4-8c2e19e6cb15\",\"targetSiteId\":null,\"validateRelatedElements\":false,\"viewMode\":null,\"maintainHierarchy\":false,\"branchLimit\":null,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Tags\",\"label\":\"Tags\",\"handle\":\"tags\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]},{\"fields\":[{\"searchable\":true,\"matchField\":null,\"placeholder\":\"Select a user\",\"defaultValue\":[],\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"limitOptions\":null,\"displayType\":\"dropdown\",\"labelSource\":\"fullName\",\"orderBy\":\"id ASC\",\"multiple\":false,\"allowSelfRelations\":false,\"localizeRelations\":false,\"maxRelations\":null,\"minRelations\":null,\"selectionLabel\":null,\"showSiteMenu\":false,\"sources\":\"*\",\"targetSiteId\":null,\"validateRelatedElements\":false,\"viewMode\":null,\"maintainHierarchy\":false,\"branchLimit\":null,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Users\",\"label\":\"Users\",\"handle\":\"users\",\"required\":false,\"instructions\":\"Please fill out this field.\"}]}]}]}','2024-05-30 13:30:43','2024-05-30 13:30:44','27464619-f32b-4b25-add3-d5db0c932f6f'),
(2,19,'{\"pages\":[{\"label\":\"Page 1\",\"settings\":{\"submitButtonLabel\":\"Contact us\",\"backButtonLabel\":\"Back\",\"showBackButton\":false,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"left\",\"cssClasses\":null,\"containerAttributes\":null,\"inputAttributes\":null,\"enableNextButtonConditions\":false,\"nextButtonConditions\":[],\"enablePageConditions\":false,\"pageConditions\":[],\"enableJsEvents\":false,\"jsGtmEventOptions\":[]},\"rows\":[{\"fields\":[{\"useMultipleFields\":true,\"prefixEnabled\":false,\"prefixCollapsed\":true,\"prefixLabel\":\"Prefix\",\"prefixPlaceholder\":null,\"prefixDefaultValue\":null,\"prefixPrePopulate\":null,\"prefixRequired\":false,\"prefixErrorMessage\":null,\"firstNameEnabled\":true,\"firstNameCollapsed\":false,\"firstNameLabel\":\"First Name\",\"firstNamePlaceholder\":\"e.g. Peter\",\"firstNameDefaultValue\":null,\"firstNamePrePopulate\":null,\"firstNameRequired\":true,\"firstNameErrorMessage\":null,\"middleNameEnabled\":false,\"middleNameCollapsed\":true,\"middleNameLabel\":\"Middle Name\",\"middleNamePlaceholder\":null,\"middleNameDefaultValue\":null,\"middleNamePrePopulate\":null,\"middleNameRequired\":false,\"middleNameErrorMessage\":null,\"lastNameEnabled\":true,\"lastNameCollapsed\":false,\"lastNameLabel\":\"Last Name\",\"lastNamePlaceholder\":\"e.g. Sherman\",\"lastNameDefaultValue\":null,\"lastNamePrePopulate\":null,\"lastNameRequired\":true,\"lastNameErrorMessage\":null,\"subfieldLabelPosition\":null,\"matchField\":null,\"placeholder\":\"Your name\",\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":\"verbb\\\\formie\\\\positions\\\\Hidden\",\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Name\",\"label\":\"Your Name\",\"handle\":\"yourName\",\"required\":false,\"instructions\":\"Please enter your full name.\"}]},{\"fields\":[{\"validateDomain\":false,\"blockedDomains\":[],\"uniqueValue\":false,\"matchField\":null,\"placeholder\":\"e.g. psherman@wallaby.com\",\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":null,\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":null,\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\Email\",\"label\":\"Email Address\",\"handle\":\"emailAddress\",\"required\":true,\"instructions\":\"Please enter your email so we can get in touch.\"}]},{\"fields\":[{\"limit\":false,\"min\":null,\"minType\":null,\"max\":null,\"maxType\":\"characters\",\"useRichText\":false,\"richTextButtons\":null,\"uniqueValue\":false,\"matchField\":null,\"placeholder\":\"e.g. The reason for my enquiry is...\",\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":null,\"inputAttributes\":null,\"includeInEmail\":true,\"enableConditions\":false,\"conditions\":null,\"enableContentEncryption\":false,\"visibility\":null,\"formId\":null,\"isNested\":false,\"type\":\"verbb\\\\formie\\\\fields\\\\formfields\\\\MultiLineText\",\"label\":\"Message\",\"handle\":\"message\",\"required\":true,\"instructions\":\"Please enter your comments.\"}]}]}]}','2024-05-30 13:30:43','2024-05-30 13:30:44','c01c46bd-bec3-40a7-923d-77bb27cac304');
/*!40000 ALTER TABLE `formie_newlayout` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Dumping data for table `formie_newnestedlayout`
--

LOCK TABLES `formie_newnestedlayout` WRITE;
/*!40000 ALTER TABLE `formie_newnestedlayout` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `formie_newnestedlayout` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
set autocommit=0;
INSERT INTO `formie_pagesettings` VALUES
(1,10,98,'{\"submitButtonLabel\":\"Contact us\",\"backButtonLabel\":\"Back\",\"showBackButton\":false,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"left\",\"cssClasses\":null,\"containerAttributes\":null,\"inputAttributes\":null,\"enableNextButtonConditions\":false,\"nextButtonConditions\":[],\"enablePageConditions\":false,\"pageConditions\":[],\"enableJsEvents\":false,\"jsGtmEventOptions\":[]}','2023-09-02 11:34:09','2023-09-02 11:34:09','fdd7d05b-9f44-4035-abf5-0d79724a7e7e'),
(2,11,99,'{\"submitButtonLabel\":\"Submit\",\"backButtonLabel\":\"Back\",\"showBackButton\":false,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"left\",\"cssClasses\":null,\"containerAttributes\":null,\"inputAttributes\":null,\"enableNextButtonConditions\":false,\"nextButtonConditions\":[],\"enablePageConditions\":false,\"pageConditions\":[],\"enableJsEvents\":false,\"jsGtmEventOptions\":[]}','2023-09-02 11:34:24','2023-09-02 11:34:24','ed595d25-eb51-43d3-9a77-cef03572b4b4'),
(3,12,100,'{\"submitButtonLabel\":\"Submit\",\"backButtonLabel\":\"Back\",\"showBackButton\":false,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"left\",\"cssClasses\":null,\"containerAttributes\":null,\"inputAttributes\":null,\"enableNextButtonConditions\":false,\"nextButtonConditions\":[],\"enablePageConditions\":false,\"pageConditions\":[],\"enableJsEvents\":false,\"jsGtmEventOptions\":[]}','2023-09-02 11:34:24','2023-09-02 11:34:24','c33c85d6-0deb-4378-b38e-1477ee398cc8'),
(4,13,101,'{\"submitButtonLabel\":\"Next\",\"backButtonLabel\":\"Back\",\"showBackButton\":false,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"right\",\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"enableNextButtonConditions\":false,\"nextButtonConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enablePageConditions\":false,\"pageConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableJsEvents\":false,\"jsGtmEventOptions\":[]}','2023-09-02 11:34:24','2023-09-02 11:34:24','9cf8c1e0-29c1-4dfe-90f8-44886ec6a1bc'),
(5,13,102,'{\"submitButtonLabel\":\"Next\",\"backButtonLabel\":\"Back\",\"showBackButton\":true,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"left-right\",\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"enableNextButtonConditions\":false,\"nextButtonConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enablePageConditions\":false,\"pageConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableJsEvents\":false,\"jsGtmEventOptions\":[]}','2023-09-02 11:34:24','2023-09-02 11:34:24','09ed1926-c21a-4f71-a1b2-dbf6e6038e05'),
(6,13,103,'{\"submitButtonLabel\":\"Finish\",\"backButtonLabel\":\"Back\",\"showBackButton\":true,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"left-right\",\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"enableNextButtonConditions\":false,\"nextButtonConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enablePageConditions\":false,\"pageConditions\":{\"showRule\":\"show\",\"conditionRule\":\"all\",\"conditions\":[]},\"enableJsEvents\":false,\"jsGtmEventOptions\":[]}','2023-09-02 11:34:24','2023-09-02 11:34:24','b268a453-da38-4252-899e-291306c9b434');
...
set autocommit=0;
INSERT INTO `formie_rows` VALUES
(1,10,1330,0,'2023-09-02 11:34:09','2023-09-02 11:34:09','7ed5b20f-3321-4d3e-a323-89c086531c45'),
(2,10,1331,1,'2023-09-02 11:34:09','2023-09-02 11:34:09','a411e90e-6b0f-461e-853e-60f48bb2d9bf'),
(3,10,1332,2,'2023-09-02 11:34:09','2023-09-02 11:34:09','18e3f17d-a341-423b-b42f-598c05416a55'),
(4,11,1333,0,'2023-09-02 11:34:24','2023-09-02 11:34:24','4893e4fe-6258-407f-bc2f-99e58ec0ff1d'),
(5,12,1334,0,'2023-09-02 11:34:24','2023-09-02 11:34:24','d29db502-334a-4505-8965-f6444a7c498e'),
(6,13,1335,0,'2023-09-02 11:34:24','2023-09-02 11:34:24','04c78275-da47-42b6-8f7c-29af83885e1b'),
(7,13,1336,1,'2023-09-02 11:34:24','2023-09-02 11:34:24','5324274a-976c-4a55-870c-25b292545040'),
(8,13,1337,2,'2023-09-02 11:34:24','2023-09-02 11:34:24','86719941-fe63-4a77-8e79-e7a10846754f'),
(9,13,1338,3,'2023-09-02 11:34:24','2023-09-02 11:34:24','7c26c53b-686c-4798-9544-3d158f717574'),
(10,13,1339,4,'2023-09-02 11:34:24','2023-09-02 11:34:24','9dae71b3-2eb7-48d0-930b-0481b41e8cde'),
(11,13,1340,5,'2023-09-02 11:34:24','2023-09-02 11:34:24','6cc9b963-715a-4c04-a88f-90c06578dafd'),
(12,13,1341,6,'2023-09-02 11:34:24','2023-09-02 11:34:24','b086c8f2-57dc-4cd7-a4e2-5a4cb5aa3514'),
(13,13,1342,7,'2023-09-02 11:34:24','2023-09-02 11:34:24','62f28494-a133-4930-9c74-39a00a40962a'),
(14,13,1343,8,'2023-09-02 11:34:24','2023-09-02 11:34:24','79edbbb5-9796-4fbf-9f2b-2f994d8411d4'),
(15,13,1344,9,'2023-09-02 11:34:24','2023-09-02 11:34:24','865194aa-901d-475c-b99a-279633991694'),
(16,13,1345,10,'2023-09-02 11:34:24','2023-09-02 11:34:24','f8008da5-f172-4e9b-bd61-8dced86e09ed'),
(17,13,1346,11,'2023-09-02 11:34:24','2023-09-02 11:34:24','8144462f-b816-4d54-bee8-19f0e4cb68fd'),
(18,13,1347,12,'2023-09-02 11:34:24','2023-09-02 11:34:24','c82054a6-80c8-4223-81c2-e8ea5e084e13'),
(19,13,1348,0,'2023-09-02 11:34:24','2023-09-02 11:34:24','9ab04430-b795-4a63-8eef-39e2a074454a'),
(20,13,1349,1,'2023-09-02 11:34:24','2023-09-02 11:34:24','3cd63117-31c5-44ba-8c58-80eb63bab70b'),
(21,13,1350,2,'2023-09-02 11:34:24','2023-09-02 11:34:24','fc50125c-1440-4908-80eb-0e9065934d61'),
(22,13,1351,3,'2023-09-02 11:34:24','2023-09-02 11:34:24','9d089bcc-d27d-48df-91f9-5174012d53e1'),
(23,13,1352,4,'2023-09-02 11:34:24','2023-09-02 11:34:24','d4af4b22-7281-41c4-adb1-8562446e9d4e'),
(24,13,1353,5,'2023-09-02 11:34:24','2023-09-02 11:34:24','7099c176-e07b-41b7-848d-59fc308311bb'),
(25,13,1354,6,'2023-09-02 11:34:24','2023-09-02 11:34:24','8188f3ab-5785-45fd-b7e5-ed7fe1045914'),
(26,13,1355,7,'2023-09-02 11:34:24','2023-09-02 11:34:24','9ff97c5a-197b-40f2-a5ea-f140363da547'),
(27,13,1356,8,'2023-09-02 11:34:24','2023-09-02 11:34:24','a6e112a4-f2fa-4a80-9374-d6b7f6dbb3e3'),
(28,13,1357,9,'2023-09-02 11:34:24','2023-09-02 11:34:24','19463668-618f-4d22-8b64-e76771ec2c75'),
(29,13,1358,10,'2023-09-02 11:34:24','2023-09-02 11:34:24','0fc77cbb-8d8e-4fb0-bb47-3930a0f3e4b3'),
(30,13,1359,11,'2023-09-02 11:34:24','2023-09-02 11:34:24','2a806477-08cd-4ed7-a0ad-9c4475aeaea4'),
(31,13,1360,12,'2023-09-02 11:34:24','2023-09-02 11:34:24','f1e99de8-e56c-4d42-b459-171012005fca'),
(32,13,1361,13,'2023-09-02 11:34:24','2023-09-02 11:34:24','9083899c-e8e5-4df1-8e7b-885683aa8597'),
(33,13,1362,0,'2023-09-02 11:34:24','2023-09-02 11:34:24','5369c1fd-cf58-4d53-bd0c-3b0337f19b80'),
(34,13,1363,1,'2023-09-02 11:34:24','2023-09-02 11:34:24','6433f427-b73b-49c3-bfde-ce776094b507'),
(35,13,1364,2,'2023-09-02 11:34:24','2023-09-02 11:34:24','520b89ed-b4a3-462a-82c9-411317bc7cff'),
(36,13,1365,3,'2023-09-02 11:34:24','2023-09-02 11:34:24','4eefb2a5-fdab-4929-bc1b-fe795101ae43'),
(37,13,1366,4,'2023-09-02 11:34:24','2023-09-02 11:34:24','dad03761-989f-4a15-b069-acc45d3b8a7f'),
(38,13,1367,5,'2023-09-02 11:34:24','2023-09-02 11:34:24','079c99dd-2d1a-4a94-b54f-e7362be70b25');
...
(1,'New','new','green',NULL,1,1,NULL,'2023-09-02 11:32:23','2023-09-02 11:32:23','db4546f1-7c70-4695-8bab-42fda0481ec6');
...
(217,'craft','m210829_000000_element_index_tweak','2023-09-02 11:12:06','2023-09-02 11:12:06','2023-09-02 11:12:06','f89eefa2-5a05-4e94-8582-c2a328965507'),
(218,'craft','m220209_095604_add_indexes','2023-09-02 11:12:06','2023-09-02 11:12:06','2023-09-02 11:12:06','9a7bd881-7f11-49d6-b18d-9f49774ba4f4'),
(219,'craft','m220214_000000_truncate_sessions','2023-09-02 11:12:06','2023-09-02 11:12:06','2023-09-02 11:12:06','a79e42dc-bc0d-4ecc-8783-9061b5421461'),
(220,'craft','m230221_185926_drop_element_fks','2023-09-02 11:12:06','2023-09-02 11:12:06','2023-09-02 11:12:06','bdc96522-e761-48b1-8bd4-5b8efed11c9a'),
(221,'craft','m230226_013114_drop_plugin_license_columns','2023-09-02 11:12:06','2023-09-02 11:12:06','2023-09-02 11:12:06','b97263f6-415f-45a0-93a4-1bd7a49d9db4'),
(222,'craft','m210121_145800_asset_indexing_changes','2023-09-02 11:22:19','2023-09-02 11:22:19','2023-09-02 11:22:19','25128b3c-f3b2-46cd-8139-60044c091f06'),
(223,'craft','m210624_222934_drop_deprecated_tables','2023-09-02 11:22:19','2023-09-02 11:22:19','2023-09-02 11:22:19','2aafeacb-5e8d-41a7-b63e-c2188b0bdcc0'),
(224,'craft','m210724_180756_rename_source_cols','2023-09-02 11:22:19','2023-09-02 11:22:19','2023-09-02 11:22:19','118d11cc-32af-4964-b715-828ff257af2b'),
(225,'craft','m210809_124211_remove_superfluous_uids','2023-09-02 11:22:19','2023-09-02 11:22:19','2023-09-02 11:22:19','37fa7131-fa1e-411c-a383-c44c658b5642'),
(226,'craft','m210817_014201_universal_users','2023-09-02 11:22:19','2023-09-02 11:22:19','2023-09-02 11:22:19','8ff501e2-c601-44f5-9bca-b5fa35735b0d'),
(227,'craft','m210904_132612_store_element_source_settings_in_project_config','2023-09-02 11:22:19','2023-09-02 11:22:19','2023-09-02 11:22:19','5536cc22-071e-4a36-bd06-246b4c66ffdc'),
(228,'craft','m211115_135500_image_transformers','2023-09-02 11:22:19','2023-09-02 11:22:19','2023-09-02 11:22:19','efcc51fe-b191-45ac-8fe2-325a51a3aa3a'),
(229,'craft','m211201_131000_filesystems','2023-09-02 11:22:19','2023-09-02 11:22:19','2023-09-02 11:22:19','bfc87d65-c65e-442a-bb7d-55568aeedf8c'),
(230,'craft','m220103_043103_tab_conditions','2023-09-02 11:22:19','2023-09-02 11:22:19','2023-09-02 11:22:19','d476aff2-b92e-4545-9d47-e343e4cd5dfc'),
(231,'craft','m220104_003433_asset_alt_text','2023-09-02 11:22:19','2023-09-02 11:22:19','2023-09-02 11:22:19','5323a718-72b2-4c52-a2e3-fe070b1c19ce'),
(232,'craft','m220123_213619_update_permissions','2023-09-02 11:22:19','2023-09-02 11:22:19','2023-09-02 11:22:19','a0d78a31-c44d-479e-809d-ab1f149767ba'),
(233,'craft','m220126_003432_addresses','2023-09-02 11:22:19','2023-09-02 11:22:20','2023-09-02 11:22:20','34ced4da-2f14-48d1-a4d1-6548553ab80a'),
(234,'craft','m220213_015220_matrixblocks_owners_table','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','e4e40591-49bc-4efb-9e29-8cab875df9d2'),
(235,'craft','m220222_122159_full_names','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','fbf1bb37-10dc-4996-ab4c-20ebf9d752d2'),
(236,'craft','m220223_180559_nullable_address_owner','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','279fc21e-3783-43c5-9b10-a9b4eb17bb71'),
(237,'craft','m220225_165000_transform_filesystems','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','9f2eaf9e-9153-48ae-892a-d5b22fa6cd61'),
(238,'craft','m220309_152006_rename_field_layout_elements','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','40a69327-6cf7-4c32-a241-87209f084d7d'),
(239,'craft','m220314_211928_field_layout_element_uids','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','24522598-2020-4e4a-85fb-187c4fdfca81'),
(240,'craft','m220316_123800_transform_fs_subpath','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','5d00ab40-a9a2-4250-8a95-198dbd6d0631'),
(241,'craft','m220317_174250_release_all_jobs','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','d026296e-c15a-4012-bb35-89026211559f'),
(242,'craft','m220330_150000_add_site_gql_schema_components','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','bf5db070-4e2d-4a98-859b-5545d50b32de'),
(243,'craft','m220413_024536_site_enabled_string','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','07753142-7b28-4938-9129-ff01ecfb0234'),
(244,'craft','m221027_160703_add_image_transform_fill','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','0095e74d-e4fa-40ba-bba0-7f5ba89e2076'),
(245,'craft','m221028_130548_add_canonical_id_index','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','ea0bef0e-97cf-4c45-8371-2afc81013d6d'),
(246,'craft','m221118_003031_drop_element_fks','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','47bd315d-1118-40d1-8983-07e519cdabc5'),
(247,'craft','m230131_120713_asset_indexing_session_new_options','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','77d63845-3add-4fa3-9a63-34615502c2b9'),
(248,'craft','m230531_123004_add_entry_type_show_status_field','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','e6d794a0-30be-4f78-855a-f25f0ec03b7f'),
(249,'craft','m230607_102049_add_entrytype_slug_translation_columns','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','04d58032-03db-442f-bf44-4a10f3107bd2'),
(250,'craft','m230710_162700_element_activity','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','523f65cc-ca1c-4b25-aeec-94a3a22b2726'),
(251,'craft','m230820_162023_fix_cache_id_type','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','dd9189f3-3795-4060-9cb3-096e3d9ea5f9'),
(252,'craft','m230826_094050_fix_session_id_type','2023-09-02 11:22:20','2023-09-02 11:22:20','2023-09-02 11:22:20','125c2847-13fb-425b-b8b3-edb344a9c651'),
(264,'plugin:formie','Install','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','78413a45-c5e5-4735-8b2b-1d309744fd44'),
(265,'plugin:formie','m220420_000000_stencil_add_entryid','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','00c1cc2e-dc51-46c0-bd4a-70175bf9d1cc'),
(266,'plugin:formie','m220422_000000_migrate_asset_fields','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','cd5ac109-8b6e-4152-85e4-d03942452c8b'),
(267,'plugin:formie','m220530_000000_payments','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','dbdb8495-caa6-45bb-b855-174efeff1e19'),
(268,'plugin:formie','m220727_000000_hubspot','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','c432f595-30ab-4242-af24-d2de3bb09ea0'),
(269,'plugin:formie','m220903_000000_remove_old_form_settings','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','20bba35d-7fa9-4f92-994e-def4ef5cf1cb'),
(270,'plugin:formie','m220904_000000_add_siteid_entry_redirect','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','15502d4a-0677-446b-ae07-4b4d018260aa'),
(271,'plugin:formie','m220905_000000_integration_enabled','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','56e9cbb2-b5c7-4cf1-8f93-d933baa86f2b'),
(272,'plugin:formie','m220917_000000_submission_spamclass','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','f3b8851e-94cf-4f7b-9fdf-da3d0fd026f9'),
(273,'plugin:formie','m220918_000000_email_sender','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','72659102-7f4a-4d17-8ea5-6b9c0a1b34f7'),
(274,'plugin:formie','m221130_000000_sent_notifications','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','c22916a0-d6d7-4524-9a56-30aa15938f29'),
(275,'plugin:formie','m221206_000000_fix_syncs','2023-09-02 11:32:23','2023-09-02 11:32:23','2023-09-02 11:32:23','b43facec-55a6-48d0-9f99-699e79ffd1aa'),
(276,'plugin:formie','m231010_000000_security_key','2024-05-30 13:30:43','2024-05-30 13:30:43','2024-05-30 13:30:43','5bd56199-8bb3-461f-96e9-35d386b70836'),
(277,'plugin:formie','m231223_000000_notification_handle','2024-05-30 13:30:43','2024-05-30 13:30:43','2024-05-30 13:30:43','5bde1953-2d6d-4ad9-b5dd-74a4ee6cb3e0'),
(278,'plugin:formie','m231231_000000_formie3_prep','2024-05-30 13:30:43','2024-05-30 13:30:43','2024-05-30 13:30:43','1d8c465c-1975-4445-a5d7-38fe877ecb91'),
(279,'plugin:formie','m240217_000000_sent_notification_text','2024-05-30 13:30:44','2024-05-30 13:30:44','2024-05-30 13:30:44','c4d4b4be-ee6e-431c-b14d-a14280ad57ff'),
(280,'plugin:formie','m240219_000000_formie3_prep_update','2024-05-30 13:30:44','2024-05-30 13:30:44','2024-05-30 13:30:44','8a6e5951-46fc-48ff-9a37-3d0b3e4f3c60');
...
(2,'tag-manager','2.0.0','1.0.0','2021-08-07 11:34:11','2021-08-07 11:34:11','2023-09-02 11:22:16','f3fc29ca-7679-4624-baac-5819c0cc74ab'),
(3,'formie','2.1.18','2.0.15','2023-09-02 11:32:22','2023-09-02 11:32:22','2024-06-03 09:39:06','17bb2ed9-e739-49b6-8bf4-7b437c6250d8');
...
('categoryGroups.12530c06-549d-4664-97d3-2a96906bde12.fieldLayouts.db9789d3-9833-4279-a1cb-7f14d1d50ab3.tabs.0.elementCondition','null'),
...
('categoryGroups.12530c06-549d-4664-97d3-2a96906bde12.fieldLayouts.db9789d3-9833-4279-a1cb-7f14d1d50ab3.tabs.0.elements.0.elementCondition','null'),
...
('categoryGroups.12530c06-549d-4664-97d3-2a96906bde12.fieldLayouts.db9789d3-9833-4279-a1cb-7f14d1d50ab3.tabs.0.elements.0.uid','\"cd52488a-5c19-45f7-bbed-7a380e08e508\"'),
('categoryGroups.12530c06-549d-4664-97d3-2a96906bde12.fieldLayouts.db9789d3-9833-4279-a1cb-7f14d1d50ab3.tabs.0.elements.0.userCondition','null'),
...
('categoryGroups.12530c06-549d-4664-97d3-2a96906bde12.fieldLayouts.db9789d3-9833-4279-a1cb-7f14d1d50ab3.tabs.0.elements.1.elementCondition','null'),
...
('categoryGroups.12530c06-549d-4664-97d3-2a96906bde12.fieldLayouts.db9789d3-9833-4279-a1cb-7f14d1d50ab3.tabs.0.elements.1.uid','\"37da079a-958f-4e63-b94f-c11ea05cf320\"'),
('categoryGroups.12530c06-549d-4664-97d3-2a96906bde12.fieldLayouts.db9789d3-9833-4279-a1cb-7f14d1d50ab3.tabs.0.elements.1.userCondition','null'),
...
('categoryGroups.12530c06-549d-4664-97d3-2a96906bde12.fieldLayouts.db9789d3-9833-4279-a1cb-7f14d1d50ab3.tabs.0.uid','\"ca0d1466-0bbe-407a-9611-c0cf907f0306\"'),
('categoryGroups.12530c06-549d-4664-97d3-2a96906bde12.fieldLayouts.db9789d3-9833-4279-a1cb-7f14d1d50ab3.tabs.0.userCondition','null'),
...
('dateModified','1717075844'),
('email.fromEmail','\"demo@verbb.io\"'),
('email.fromName','\"Formie Headless\"'),
('email.transportType','\"craft\\\\mail\\\\transportadapters\\\\Sendmail\"'),
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.fieldLayouts.6bbdaea4-ec82-409c-92e1-f7dba84ecfc8.tabs.0.elementCondition','null'),
...
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.fieldLayouts.6bbdaea4-ec82-409c-92e1-f7dba84ecfc8.tabs.0.elements.0.elementCondition','null'),
...
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.fieldLayouts.6bbdaea4-ec82-409c-92e1-f7dba84ecfc8.tabs.0.elements.0.type','\"craft\\\\fieldlayoutelements\\\\entries\\\\EntryTitleField\"'),
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.fieldLayouts.6bbdaea4-ec82-409c-92e1-f7dba84ecfc8.tabs.0.elements.0.uid','\"e33b605b-70e2-434a-b116-5741bf777709\"'),
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.fieldLayouts.6bbdaea4-ec82-409c-92e1-f7dba84ecfc8.tabs.0.elements.0.userCondition','null'),
...
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.fieldLayouts.6bbdaea4-ec82-409c-92e1-f7dba84ecfc8.tabs.0.elements.1.elementCondition','null'),
...
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.fieldLayouts.6bbdaea4-ec82-409c-92e1-f7dba84ecfc8.tabs.0.elements.1.uid','\"172723ab-42fd-49ee-ad57-642289d24824\"'),
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.fieldLayouts.6bbdaea4-ec82-409c-92e1-f7dba84ecfc8.tabs.0.elements.1.userCondition','null'),
...
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.fieldLayouts.6bbdaea4-ec82-409c-92e1-f7dba84ecfc8.tabs.0.uid','\"1f190d05-094d-447c-ae3c-f6bbcaa2d7f7\"'),
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.fieldLayouts.6bbdaea4-ec82-409c-92e1-f7dba84ecfc8.tabs.0.userCondition','null'),
...
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.showStatusField','true'),
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.slugTranslationKeyFormat','null'),
('entryTypes.ee2e044d-867d-4cdf-b1b3-4e0d51e7a818.slugTranslationMethod','\"site\"'),
...
('fields.2a7dfeb1-2876-4d66-8cb7-ccb1c55b042a.instructions','null'),
...
('fields.2a7dfeb1-2876-4d66-8cb7-ccb1c55b042a.settings.code','false'),
...
('fields.2a7dfeb1-2876-4d66-8cb7-ccb1c55b042a.settings.multiline','false'),
...
('formie.statuses.db4546f1-7c70-4695-8bab-42fda0481ec6.color','\"green\"'),
('formie.statuses.db4546f1-7c70-4695-8bab-42fda0481ec6.description','null'),
('formie.statuses.db4546f1-7c70-4695-8bab-42fda0481ec6.handle','\"new\"'),
('formie.statuses.db4546f1-7c70-4695-8bab-42fda0481ec6.isDefault','true'),
('formie.statuses.db4546f1-7c70-4695-8bab-42fda0481ec6.name','\"New\"'),
('formie.statuses.db4546f1-7c70-4695-8bab-42fda0481ec6.sortOrder','1'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.dataRetention','\"forever\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.dataRetentionValue','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.fileUploadsAction','\"retain\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.attachFiles','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.attachPdf','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.bcc','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.cc','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.conditions','\"{\\\"sendRule\\\":\\\"send\\\",\\\"conditionRule\\\":\\\"all\\\",\\\"conditions\\\":[]}\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.content','\"[{\\\"type\\\":\\\"paragraph\\\",\\\"content\\\":[{\\\"type\\\":\\\"text\\\",\\\"text\\\":\\\"A user submission has been made on the \\\\\\\"\\\"},{\\\"type\\\":\\\"variableTag\\\",\\\"attrs\\\":{\\\"label\\\":\\\"Form Name\\\",\\\"value\\\":\\\"{formName}\\\"}},{\\\"type\\\":\\\"text\\\",\\\"text\\\":\\\"\\\\\\\" form on \\\"},{\\\"type\\\":\\\"variableTag\\\",\\\"attrs\\\":{\\\"label\\\":\\\"Site Name\\\",\\\"value\\\":\\\"{siteName}\\\"}},{\\\"type\\\":\\\"text\\\",\\\"text\\\":\\\" at \\\"},{\\\"type\\\":\\\"variableTag\\\",\\\"attrs\\\":{\\\"label\\\":\\\"Timestamp (yyyy-mm-dd hh:mm:ss)\\\",\\\"value\\\":\\\"{timestamp}\\\"}}]},{\\\"type\\\":\\\"paragraph\\\",\\\"content\\\":[{\\\"type\\\":\\\"text\\\",\\\"text\\\":\\\"Their submission details are:\\\"}]},{\\\"type\\\":\\\"paragraph\\\",\\\"content\\\":[{\\\"type\\\":\\\"variableTag\\\",\\\"attrs\\\":{\\\"label\\\":\\\"All Form Fields\\\",\\\"value\\\":\\\"{allFields}\\\"}}]}]\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.enableConditions','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.enabled','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.formId','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.from','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.fromName','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.id','\"new981-8077\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.name','\"Admin Notification\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.pdfTemplateId','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.recipients','\"email\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.replyTo','\"{field.emailAddress}\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.replyToName','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.subject','\"A new submission was made on \\\"{formName}\\\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.templateId','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.to','\"{systemEmail}\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.toConditions','\"{\\\"toRecipients\\\":[]}\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.0.uid','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.attachFiles','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.attachPdf','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.bcc','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.cc','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.conditions','\"{\\\"sendRule\\\":\\\"send\\\",\\\"conditionRule\\\":\\\"all\\\",\\\"conditions\\\":[]}\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.content','\"[{\\\"type\\\":\\\"paragraph\\\",\\\"content\\\":[{\\\"type\\\":\\\"text\\\",\\\"text\\\":\\\"Thanks again for contacting us. Our team will get back to you as soon as we can.\\\"}]},{\\\"type\\\":\\\"paragraph\\\",\\\"content\\\":[{\\\"type\\\":\\\"text\\\",\\\"text\\\":\\\"As a reminder, you submitted the following details at \\\"},{\\\"type\\\":\\\"variableTag\\\",\\\"attrs\\\":{\\\"label\\\":\\\"Timestamp (yyyy-mm-dd hh:mm:ss)\\\",\\\"value\\\":\\\"{timestamp}\\\"}}]},{\\\"type\\\":\\\"paragraph\\\",\\\"content\\\":[{\\\"type\\\":\\\"variableTag\\\",\\\"attrs\\\":{\\\"label\\\":\\\"All Form Fields\\\",\\\"value\\\":\\\"{allFields}\\\"}}]}]\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.enableConditions','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.enabled','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.formId','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.from','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.fromName','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.id','\"new7052-5168\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.name','\"User Notification\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.pdfTemplateId','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.recipients','\"email\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.replyTo','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.replyToName','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.subject','\"Thanks for contacting us!\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.templateId','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.to','\"{field.emailAddress}\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.toConditions','\"{\\\"toRecipients\\\":[]}\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.notifications.1.uid','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.id','\"new1272610411\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.label','\"Page 1\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.notificationFlag','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.brandNewField','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.handle','\"yourName\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.hasLabel','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.id','\"new7715-7348\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.label','\"Your Name\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.conditions','\"{\\\"showRule\\\":\\\"show\\\",\\\"conditionRule\\\":\\\"all\\\",\\\"conditions\\\":[]}\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.firstNameCollapsed','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.firstNameDefaultValue','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.firstNameEnabled','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.firstNameLabel','\"First Name\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.firstNamePlaceholder','\"e.g. Peter\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.firstNameRequired','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.handle','\"yourName\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.instructions','\"Please enter your full name.\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.instructionsPosition','\"verbb\\\\formie\\\\positions\\\\AboveInput\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.label','\"Your Name\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.labelPosition','\"verbb\\\\formie\\\\positions\\\\Hidden\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.lastNameCollapsed','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.lastNameDefaultValue','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.lastNameEnabled','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.lastNameLabel','\"Last Name\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.lastNamePlaceholder','\"e.g. Sherman\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.lastNameRequired','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.maxType','\"characters\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.middleNameCollapsed','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.middleNameDefaultValue','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.middleNameEnabled','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.middleNameLabel','\"Middle Name\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.placeholder','\"Your name\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.prefixCollapsed','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.prefixDefaultValue','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.prefixEnabled','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.prefixLabel','\"Prefix\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.subfieldLabelPosition','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.useMultipleFields','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.settings.visibility','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.fields.0.type','\"verbb\\\\formie\\\\fields\\\\formfields\\\\Name\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.0.id','\"new8990-9934\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.brandNewField','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.handle','\"emailAddress\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.hasLabel','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.id','\"new6482-9528\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.label','\"Email Address\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.settings.handle','\"emailAddress\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.settings.instructions','\"Please enter your email so we can get in touch.\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.settings.instructionsPosition','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.settings.label','\"Email Address\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.settings.labelPosition','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.settings.maxType','\"characters\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.settings.placeholder','\"e.g. psherman@wallaby.com\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.settings.required','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.fields.0.type','\"verbb\\\\formie\\\\fields\\\\formfields\\\\Email\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.1.id','\"new9524-8509\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.brandNewField','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.handle','\"message\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.hasLabel','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.id','\"new982-7322\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.label','\"Message\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.settings.conditions','\"{\\\"showRule\\\":\\\"show\\\",\\\"conditionRule\\\":\\\"all\\\",\\\"conditions\\\":[]}\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.settings.handle','\"message\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.settings.instructions','\"Please enter your comments.\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.settings.instructionsPosition','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.settings.label','\"Message\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.settings.labelPosition','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.settings.maxType','\"characters\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.settings.placeholder','\"e.g. The reason for my enquiry is...\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.settings.required','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.settings.visibility','\"\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.fields.0.type','\"verbb\\\\formie\\\\fields\\\\formfields\\\\MultiLineText\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.rows.2.id','\"new2177-9685\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.settings.backButtonLabel','\"Back\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.settings.buttonsPosition','\"left\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.settings.label','\"Page 1\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.settings.showBackButton','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.settings.submitButtonLabel','\"Contact us\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.pages.0.sortOrder','0'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.collectIp','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.collectUser','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.dataRetention','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.dataRetentionValue','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.defaultEmailTemplateId','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.defaultInstructionsPosition','\"verbb\\\\formie\\\\positions\\\\AboveInput\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.defaultLabelPosition','\"verbb\\\\formie\\\\positions\\\\AboveInput\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.disableCaptchas','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.displayCurrentPageTitle','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.displayFormTitle','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.displayPageProgress','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.displayPageTabs','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.errorMessage.0.content.0.text','\"Couldn’t save submission due to errors.\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.errorMessage.0.content.0.type','\"text\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.errorMessage.0.type','\"paragraph\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.errorMessagePosition','\"top-form\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.fileUploadsAction','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.limitSubmissions','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.limitSubmissionsMessage','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.limitSubmissionsNumber','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.limitSubmissionsType','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.loadingIndicator','\"spinner\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.loadingIndicatorText','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.progressPosition','\"end\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.redirectUrl','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.requireUser','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.requireUserMessage','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.scheduleForm','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.scheduleFormEnd','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.scheduleFormExpiredMessage','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.scheduleFormPendingMessage','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.scheduleFormStart','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.scrollToTop','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.submissionTitleFormat','\"{timestamp}\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.submitAction','\"message\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.submitActionFormHide','false'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.submitActionMessage.0.content.0.text','\"Thank you for contacting us! Our team will get in touch shortly to follow up on your message.\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.submitActionMessage.0.content.0.type','\"text\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.submitActionMessage.0.type','\"paragraph\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.submitActionMessagePosition','\"top-form\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.submitActionMessageTimeout','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.submitActionTab','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.submitActionUrl','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.submitMethod','\"ajax\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.validationOnFocus','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.settings.validationOnSubmit','true'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.data.userDeletedAction','\"retain\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.defaultStatus','\"db4546f1-7c70-4695-8bab-42fda0481ec6\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.handle','\"contactForm\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.name','\"Contact Form\"'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.submitActionEntry','null'),
('formie.stencils.e100dd43-9a1a-4980-bfb5-806d761f1192.template','null'),
('fs.demo.hasUrls','false'),
('fs.demo.name','\"Demo\"'),
('fs.demo.settings.path','\"@webroot/uploads/demo\"'),
('fs.demo.type','\"craft\\\\fs\\\\Local\"'),
('fs.demo.url','null'),
('globalSets.6b96e0b0-0c3f-4de5-8631-0de30b34872c.fieldLayouts.f6ac1175-0650-454a-87ac-3af1d5ed99c4.tabs.0.elementCondition','null'),
('globalSets.6b96e0b0-0c3f-4de5-8631-0de30b34872c.fieldLayouts.f6ac1175-0650-454a-87ac-3af1d5ed99c4.tabs.0.elements.0.elementCondition','null'),
...
('globalSets.6b96e0b0-0c3f-4de5-8631-0de30b34872c.fieldLayouts.f6ac1175-0650-454a-87ac-3af1d5ed99c4.tabs.0.elements.0.uid','\"2b8946be-0cd8-46d6-ad46-7e61b1f56646\"'),
('globalSets.6b96e0b0-0c3f-4de5-8631-0de30b34872c.fieldLayouts.f6ac1175-0650-454a-87ac-3af1d5ed99c4.tabs.0.elements.0.userCondition','null'),
...
('globalSets.6b96e0b0-0c3f-4de5-8631-0de30b34872c.fieldLayouts.f6ac1175-0650-454a-87ac-3af1d5ed99c4.tabs.0.uid','\"2eb1fa2c-f225-4b23-b5ae-8351c1fc67c0\"'),
('globalSets.6b96e0b0-0c3f-4de5-8631-0de30b34872c.fieldLayouts.f6ac1175-0650-454a-87ac-3af1d5ed99c4.tabs.0.userCondition','null'),
...
('graphql.schemas.e721824b-3a96-44ce-979f-1e77d543df97.scope.16','\"sites.00079eeb-bb55-40b2-867b-65ed3665219f:read\"'),
...
('meta.__names__.db4546f1-7c70-4695-8bab-42fda0481ec6','\"New\"'),
('meta.__names__.e100dd43-9a1a-4980-bfb5-806d761f1192','\"Contact Form\"'),
...
('plugins.formie.licenseKey','\"EBTN7CN6DN91HL7M2DQHB3ZL\"'),
('plugins.formie.schemaVersion','\"2.0.15\"'),
...
('sites.00079eeb-bb55-40b2-867b-65ed3665219f.enabled','true'),
...
('tagGroups.9ee7d758-c5b1-4f5a-a4d4-8c2e19e6cb15.fieldLayouts.4ac58eaa-d7bd-49c0-bb3a-ab20c42ef558.tabs.0.elementCondition','null'),
...
('tagGroups.9ee7d758-c5b1-4f5a-a4d4-8c2e19e6cb15.fieldLayouts.4ac58eaa-d7bd-49c0-bb3a-ab20c42ef558.tabs.0.elements.0.elementCondition','null'),
...
('tagGroups.9ee7d758-c5b1-4f5a-a4d4-8c2e19e6cb15.fieldLayouts.4ac58eaa-d7bd-49c0-bb3a-ab20c42ef558.tabs.0.elements.0.uid','\"3aab9b9e-361f-4f41-9669-ebf80d318832\"'),
('tagGroups.9ee7d758-c5b1-4f5a-a4d4-8c2e19e6cb15.fieldLayouts.4ac58eaa-d7bd-49c0-bb3a-ab20c42ef558.tabs.0.elements.0.userCondition','null'),
...
('tagGroups.9ee7d758-c5b1-4f5a-a4d4-8c2e19e6cb15.fieldLayouts.4ac58eaa-d7bd-49c0-bb3a-ab20c42ef558.tabs.0.elements.1.elementCondition','null'),
...
('tagGroups.9ee7d758-c5b1-4f5a-a4d4-8c2e19e6cb15.fieldLayouts.4ac58eaa-d7bd-49c0-bb3a-ab20c42ef558.tabs.0.elements.1.uid','\"c4790275-fa7d-4b4c-add8-a755429a44dc\"'),
('tagGroups.9ee7d758-c5b1-4f5a-a4d4-8c2e19e6cb15.fieldLayouts.4ac58eaa-d7bd-49c0-bb3a-ab20c42ef558.tabs.0.elements.1.userCondition','null'),
...
('tagGroups.9ee7d758-c5b1-4f5a-a4d4-8c2e19e6cb15.fieldLayouts.4ac58eaa-d7bd-49c0-bb3a-ab20c42ef558.tabs.0.uid','\"60f45000-9c35-4004-98f2-bb76f81cd0cd\"'),
('tagGroups.9ee7d758-c5b1-4f5a-a4d4-8c2e19e6cb15.fieldLayouts.4ac58eaa-d7bd-49c0-bb3a-ab20c42ef558.tabs.0.userCondition','null'),
...
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.fieldLayouts.a65d044a-042f-4258-994d-611713ff5b4d.tabs.0.elementCondition','null'),
...
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.fieldLayouts.a65d044a-042f-4258-994d-611713ff5b4d.tabs.0.elements.0.elementCondition','null'),
...
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.fieldLayouts.a65d044a-042f-4258-994d-611713ff5b4d.tabs.0.elements.0.type','\"craft\\\\fieldlayoutelements\\\\assets\\\\AssetTitleField\"'),
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.fieldLayouts.a65d044a-042f-4258-994d-611713ff5b4d.tabs.0.elements.0.uid','\"a852264a-dd9e-4eba-812d-a16e2790442b\"'),
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.fieldLayouts.a65d044a-042f-4258-994d-611713ff5b4d.tabs.0.elements.0.userCondition','null'),
...
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.fieldLayouts.a65d044a-042f-4258-994d-611713ff5b4d.tabs.0.elements.1.elementCondition','null'),
...
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.fieldLayouts.a65d044a-042f-4258-994d-611713ff5b4d.tabs.0.elements.1.uid','\"f3b7fda1-a9ac-402a-b069-c8a9dd6d5033\"'),
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.fieldLayouts.a65d044a-042f-4258-994d-611713ff5b4d.tabs.0.elements.1.userCondition','null'),
...
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.fieldLayouts.a65d044a-042f-4258-994d-611713ff5b4d.tabs.0.uid','\"ad782584-77de-476d-8738-246c29fce5ef\"'),
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.fieldLayouts.a65d044a-042f-4258-994d-611713ff5b4d.tabs.0.userCondition','null'),
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.fs','\"demo\"'),
...
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.titleTranslationMethod','\"site\"'),
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.transformFs','null'),
('volumes.adf62689-9e99-4040-8bb3-c06de71033be.transformSubpath','\"\"');
...
(18,'slug',0,1,''),
(14,'slug',0,1,''),
(19,'title',0,1,' contact form '),
(19,'handle',0,1,' contactform '),
(19,'slug',0,1,''),
(20,'title',0,1,' fields demo '),
(20,'handle',0,1,' fieldsdemo '),
(20,'slug',0,1,''),
(21,'title',0,1,' 2024 06 02 10 22 24 '),
(21,'slug',0,1,''),
...
(15,1,NULL,'2021-08-07 11:34:38','2021-08-07 11:34:38'),
(16,1,NULL,'2021-08-07 11:34:42','2021-08-07 11:34:42'),
(17,1,NULL,'2021-08-07 11:34:44','2021-08-07 11:34:44');
...
(1,NULL,1,'Demo',NULL,'2021-08-07 00:06:01','2024-05-30 13:30:17','a61e8f67-28cc-43ec-8a76-730c60a192bf'),
(2,NULL,NULL,'Temporary filesystem',NULL,'2023-09-02 11:22:36','2023-09-02 11:22:36','e5b06441-3d7e-49f4-9a5c-0c2e31d7056b'),
(3,2,NULL,'user_1','user_1/','2023-09-02 11:22:36','2023-09-02 11:22:36','ce960e37-356a-4967-942e-88a86d2386d4');
...
(1,2,'Demo','demo','demo',NULL,'','site',NULL,1,'2021-08-07 00:06:01','2024-05-30 13:30:17',NULL,'adf62689-9e99-4040-8bb3-c06de71033be');
