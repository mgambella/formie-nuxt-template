export function resetValidation(el) {
  if (!el) return console.error('No element provided to reset validation')
...
export function showValidation(pristine) {
  const appliedErrors = []
...
export function runValidation(pristine, $page) {
  if (!$page) return console.error('No page element provided to run validation')
...
export function applyServerValidation(pristine, el, error) {
  let errors = {}
